...
public class FixDexUtils {
    ...
    public static void loadFixedDex(Context context, File patchFilesDir) {
        ...
        Log.i("info","fileDir="+fileDir+new File(fileDir+"/"+"classes2.dex").exists());
        try {
...
//                    Log.i("info","add file="+file.getName());
//                    loadedDex.add(file);// 存入集合
//                }
//            }
            File file=new File(fileDir+"/"+"classes2.jar");
            if(file.exists()){
                loadedDex.add(file);// 存入集合
                Log.i("info","1111111");
            }
            ...
            e.printStackTrace();
            Toast.makeText(context,"读取不到文件，请检查权限或者文件", Toast.LENGTH_SHORT).show();
        }
    }
